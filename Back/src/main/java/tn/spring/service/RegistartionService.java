...
public class RegistartionService {
	...
	@Autowired
	IEmailSender IE;
	public String register(RegistrationRequest request,int id) {
	...
	public String registerprof(RegistrationRequest request) {
		// TODO Auto-generated method stub
	 boolean test =	EV.test(request.getEmail());
	 if (!test) {
		 throw new IllegalStateException("email not valid");
	...
	public String registeradd(RegistrationRequest request) {
		// TODO Auto-generated method stub
	 boolean test =	EV.test(request.getEmail());
	 if (!test) {
		 throw new IllegalStateException("email not valid");
	 }
	 String token = US.SignUpADMIN(
			 new AppUser(
					 request.getFirstName(),
                     request.getLastName(),	
					 request.getEmail(),
